...
import (
	...
	v1 "github.com/cometbft/cometbft/api/cometbft/store/v1"
)
...
func (_m *BlockStore) LoadTxInfo(hash []byte) *v1.TxInfo {
	ret := _m.Called(hash)
	...
	var r0 *v1.TxInfo
	if rf, ok := ret.Get(0).(func([]byte) *v1.TxInfo); ok {
		r0 = rf(hash)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1.TxInfo)
		}
	}
